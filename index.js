  ...
  try{
    ...
    try{
      await mailer.sendMail({
        ...
        html:`<div style="font-family:sans-serif;max-width:400px;margin:0 auto;padding:32px;background:#060606;color:#fff;border:1px solid #222;">
          <div style="font-size:28px;font-weight:700;letter-spacing:0.12em;margin-bottom:8px;">100<span style="color:#08f7f7;">TH</span></div>
          <p style="color:rgba(255,255,255,0.6);margin-bottom:24px;">Your verification code:</p>
          <div style="font-size:48px;font-weight:900;letter-spacing:0.2em;color:#08f7f7;text-align:center;padding:20px;background:rgba(8,247,247,0.06);border:1px solid rgba(8,247,247,0.2);">${code}</div>
          <p style="color:rgba(255,255,255,0.4);font-size:12px;margin-top:20px;">This code expires in 10 minutes. Do not share it with anyone.</p>
        </div>`
      });
